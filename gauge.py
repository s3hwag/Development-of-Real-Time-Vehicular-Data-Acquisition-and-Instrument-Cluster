...
class AnalogGaugeWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.initial_value_fontsize = 22
    ...
    def create_scale_marker_values_text(self):
        ...
        for i in range(self.scala_main_count + 1):
            ...
            flags = int(text[4])
            text_string = text[5]
            painter.drawText(x, y, width, height, flags, text_string)
        # painter.restore()
    ...
    def create_values_text(self):
        ...
        # xShadow = 3.0
        # yShadow = 3.0
        font = QFont("FamilyName", 12, QFont.Bold, True)
        fm = QFontMetrics(font)
        ...
        font = QFont(self.value_fontname)
        font.setPointSize(int(self.value_fontsize))
